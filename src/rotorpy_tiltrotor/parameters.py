...
def default_tiltrotor_params() -> dict:
    params = {
        ...
        "gravity": 9.81,
        "rotor_pos": np.array([[0.90,1.25,0.05],[-0.90,1.25,0.05],[-0.90,-1.25,0.05],[0.90,-1.25,0.05]], dtype=float),
...
def initial_state(params: dict | None = None) -> dict:
    ...
    return {
        ...
        "surfaces": np.zeros(3),
        "energy_j": np.array(p["battery_capacity_j"] * p["battery_initial_soc"]),
    }
